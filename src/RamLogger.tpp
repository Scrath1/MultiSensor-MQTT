...
template <uint32_t maxNumberOfMessages, uint32_t maxMessageLength, uint32_t maxTimestampStrLength>
RC_t RamLogger<maxNumberOfMessages, maxMessageLength, maxTimestampStrLength>::get(int32_t idx, char str[],
                                                                                  uint32_t strLen) const {
...
template <uint32_t maxNumberOfMessages, uint32_t maxMessageLength, uint32_t maxTimestampStrLength>
RC_t RamLogger<maxNumberOfMessages, maxMessageLength, maxTimestampStrLength>::setTimestampFunction(
